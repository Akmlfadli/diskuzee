                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card shadow-lg rounded-lg hover-shadow">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted">Deskripsi: <strong>{{ $trendings->posts }}</strong></p>

                            <!-- Display the number of comments for debugging -->
                            <p class="text-muted">Post By: {{ $trendings->postauthor }}</p>
                            <p class="text-muted">Most Comments: {{ $trendings->mostcomments }}</p>
            ...
            <div class="p-6 text-gray-900" style="display: flex; flex-wrap: wrap;">
                <div class="container">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $report->alasan }}</td>
                                    <td><button class="btn btn-danger" onclick="window.location.href = '/posts/delete?uuid={{ $report->uuid }}'">DELETE</button></td>
                                </tr>
                                @endforeach
                                @else
                                <script>window.location.href = '/home'</script>
                    ...
                    <div class="d-block d-md-none">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title">UUID: {{ $report->uuid }}</h5>
                                <div class="row">
                                    <div class="col-3">
                                        <div style="height: 50px; width: 50px; background-image: url('{{ $report->profile }}'); background-size: cover; border-radius: 50%;"></div>
                                    </div>
